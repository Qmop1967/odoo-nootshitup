class ZohoOdooSyncFinal:
    ...
    def run_sync_cycle(self):
        ...
        self.logger.info("🚀 Starting sync cycle with images and price lists...")
        try:
            # Sync price lists first
            pl_result = self.sync_active_pricelists()
            if pl_result:
                self.logger.info("✅ Price lists synced successfully.")
            else:
                self.logger.warning("⚠️ Price list sync encountered errors.")
            # Perform product synchronization as before
