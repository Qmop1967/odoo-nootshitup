...
if __name__ == "__main__":
    ...
    if all_successful:
        print("
🎉🎉🎉 Full Contact Migration (Customers & Vendors) completed successfully! 🎉🎉🎉")
    else:
        print("
⚠️⚠️⚠️ Full Contact Migration (Customers & Vendors) completed with some errors. Please check logs. ⚠️⚠️⚠️")
        exit(1) 